...
function LRSettingViewModel(parent){
	var self = this;
	this.listoptions = ToraAsiaLeaveRequestInfo.ListManagement.LeaveRequestConfiguration.Title;
	...
	this.NavLinkArr = ko.observableArray([
    	{ title: "เพิ่ม แก้ไข ลบ ประเภทการลา", url: ToraAsiaLeaveRequestInfo.ListManagement.LeaveRequestCondition.Url, icon: "glyphicon-list-alt" },
    	{ title: "เพิ่ม แก้ไข ลบ ข้อมูลพนักงาน", url: ToraAsiaLeaveRequestInfo.ListManagement.LeaveRequestOfficer.Url, icon: "glyphicon-user" },
    	...
    	{ title: "พื้นที่จัดเก็บการลา", url: ToraAsiaLeaveRequestInfo.ListManagement.LeaveRequestItem.Url, icon: "glyphicon-hdd" },
    	{ title: "จัดการวันหยุด", url: ToraAsiaLeaveRequestInfo.ListManagement.LeaveRequestHoliday.Url, icon: "glyphicon-time" },
    ]);
